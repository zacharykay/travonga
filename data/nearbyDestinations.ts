import { DestinationsDetails } from "../components/destinations/interfaces";

export const nearbyDestinations: DestinationsDetails = {
	canyon_de_chelly: {
		id: 'canyon-de-chelly',
	...
	greater_vancouver: {
		...
		page_url:
			'/destinations/canada/british-columbia/greater-vancouver-attractions-guide',
		image_url:
	...
	victoria: {
		...
		stateName: 'British Columbia',
		page_url:
			'/destinations/canada/british-columbia/victoria-and-vancouver-island-attractions-guide',
		image_url:
	...
	copenhagen: {
		...
		image_url:
			'https://www.travelimager.com/images/denmark/Denmark-Copenhagen-Nyhavn-Canal.jpg',
		image_alt:
			"Iconic colorful townhouse row along Copenhagen's Nyhavn Canal with many parked boats and tourists",
		cc_image_url:
			'https://commons.wikimedia.org/w/index.php?title=File:Nyhavn_copenhagen.jpg&action=history',
	...
	oslo: {
		...
		image_url:
			'https://www.travelimager.com/images/norway/Norway-Oslo-Operahuset-Oslo-Opera-House.jpg',
		image_alt:
			'Ultra-modern Oslo Opera House set amongst the water with its slanted roofs for people to walk up',
		cc_image_url:
			'https://commons.wikimedia.org/w/index.php?title=File:Oslo_Opera_House_hus_2014_hav.JPG&action=history',
	...
	stockholm: {
		...
		image_url:
			'https://www.travelimager.com/images/sweden/Sweden-Stockholm-Riddarholmen-Island.jpg',
		image_alt:
			"Historic buildings of Stockholm's Riddarholmen Island and their reflection in the water during golden hour",
