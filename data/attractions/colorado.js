export const attractionGuides = [
	{
		...
		meta: {
			page_title:
				'Attractions Guide to Denver to Glenwood Springs & Aspen, Colorado',
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Aspen-Maroon-Bells-and-Lake-Fall-Colors-150x150.jpg',
			meta_description:
				'Discover top attractions between Denver to Glenwood Springs, Colorado + Aspen, and plan the perfect trip with our savable Attraction Lists for Google Maps',
			meta_keywords:
				'apsen and glenwood springs attractions guide, apsen and glenwood springs top attractions, apsen and glenwood springs destination guide, apsen and glenwood springs google maps list, apsen and glenwood springs colorado attractions',
			social_media_title:
				'Denver to Glenwood Springs & Aspen, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Aspen-Maroon-Bells-and-Lake-Fall-Colors.jpg'
		},
		attractionMapLinks: {
		...
		attractions: {
			carousel_1: [
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Arapaho-and-Roosevelt-National-Forests-Mount-Evans-Wilderness-Summit-Lake-Park.jpg',
					image_alt:
						"Beautiful meadows of Summit Lake Park within the Mount Evans Wilderness of Colorado's Arapaho and Roosevelt National Forests",
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:2006-07-16_Summit_Lake_Park_Colorado.jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/w/index.php?title=File:2006-07-16_Summit_Lake_Park_Colorado.jpg&action=history',
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Arapaho-and-Roosevelt-National-Forests-Saint-Marys-Glacier-and-Lake.jpg',
					image_alt:
						'Overlooking St. Mary Lake beside the St. Mary Glacier along the Rocky Mountains of Arapaho and Roosevelt National Forests',
					cc_image_url:
						'https://www.flickr.com/photos/kevinekmark/36345987866/in/photostream/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Arapaho-and-Roosevelt-National-Forests-Loveland-Pass-View.jpg',
					image_alt:
						'Snowy mountain peaks along the Continental Divide seen from Loveland Pass within the Arapaho and Roosevelt National Forests',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-White-River-National-Forest-Silverthorne-Dillon-Reservoir-Old-Dillon-Reservoir-Trailhead-View.jpg',
					image_alt:
						'Overlooking the Old Dillon Reservoir and its islands surrounded by the White River National Forest near Silverthorne',
					cc_image_url:
						'https://www.flickr.com/photos/adifferentbrian/36503244935/in/photostream/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Breckenridge-Main-Street-Christmas-Decorations.jpg',
					image_alt:
						"Christmas decorations among the shops and lamposts lining Downtown Breckenridge, Colorado's Main Street area",
					cc_image_url:
						'https://www.flickr.com/photos/11866892@N05/37494776701',
			...
			carousel_2: [
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-White-River-National-Forest-Aspen-Grottos-Trail.jpg',
					image_alt:
						'Small grottos and waterfalls along a canyon gorge along the Roaring Fork River of the White River National Forest near Aspen',
					cc_image_url:
						'https://www.flickr.com/photos/markbyzewski/36353386143/',
...

				{
					...
					cc_author_url:
						'https://commons.wikimedia.org/wiki/User:Rhododendrites',
...

				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/lhanaphotography/6183699068',
			...
			carousel_3: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-White-River-National-Forest-Glenwood-Sprins-Glenwood-Hot-Springs-Pool.jpg',
					image_alt:
						'Overlooking the massive outdoor Glenwood Hot Springs Pool with mountains of Glenwood Springs, Colorado in background',
					cc_image_url:
						'https://www.flickr.com/photos/jasoncipriani/13892053626/in/photostream/',
...

				{
					...
					image_alt:
						'Stalagmite ceilings within the Glenwood Caverns Adventure Park Cave in the mountains above Glenwood Springs, Colorado',
					cc_image_url:
						'https://www.flickr.com/photos/jasoncipriani/13915217783/in/photostream/',
					cc_author_url: 'https://www.flickr.com/photos/jasoncipriani/',
					cc_author: 'Jason Cipriani',
					cc_license_url: null,
					cc_license_url:
...

				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/rocketman80120/511739969/',
	...
	},
	{
		...
		meta: {
			page_title:
				'Attractions Guide to Black Canyon of the Gunnison & Million Dollar Highway, Colorado',
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Black-Canyon-of-the-Gunnison-National-Park-Gunnison-River-and-Canyon-View-150x150.jpg',
			meta_description:
				'Discover top attractions for the Million Dollar Highway & Black Canyon of the Gunnison National Park, Colorado & plan with our Google Maps Attraction Lists',
			meta_keywords:
				'black canyon of the gunnison attractions guide, black canyon of the gunnison top attractions, black canyon of the gunnison destination guide, black canyon of the gunnison google maps list, black canyon of the gunnison colorado attractions',
			social_media_title:
				'Black Canyon of the Gunnison & Million Dollar Highway, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Black-Canyon-of-the-Gunnison-National-Park-Gunnison-River-and-Canyon-View.jpg'
		},
		attractionMapLinks: {
		...
		attractions: {
			carousel_1: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Black-Canyon-of-the-Gunnison-National-Park-Gunnison-Point.jpg',
					image_alt:
						"Striking views overlooking Colorado's Black Canyon of the Gunnison from Gunnison Point",
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Black-Canyon-of-the-Gunnison-National-Park-Devils-Lookout.jpg',
					image_alt:
						'Natural painted stripes on the walls of the Black Canyon of the Gunnison seen from Devils Lookout',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Black-Canyon-of-the-Gunnison-National-Park-Chasm-View.jpg',
					image_alt:
						"Steep Chasm View overlooking the Gunnison River flowing through Colorado's Black Canyon of the Gunnison National Park",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Black-Canyon-of-the-Gunnison-National-Park-Warner-Point.jpg',
					image_alt:
						'Warner Point Nature Trail view overlooking a wide section of the steep Black Canyon of the Gunnison',
			...
			carousel_2: [
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Ouray-Beaumont-Hotel.jpg',
					image_alt:
						"Facade of the historic Beaumont Hotel along Ouray, Colorado's main street",
					cc_image_url:
						'https://pixabay.com/photos/beaumont-hotel-ouray-colorado-town-1679707/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Ouray-Box-Canyon-Falls-Park-Box-Canyon.jpg',
					image_alt:
						'Overlooking Box Canyon Falls flowing through a tall steep canyon in Ouray, Colorado',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Canyon_Creek_Before_the_Box_Canyon_(6309162655).jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Canyon_Creek_Before_the_Box_Canyon_(6309162655).jpg&action=history',
					cc_author: 'Greg Willis',
					cc_license_url: null,
...

				{
					...
					image_alt:
						'Overlooking the town of Ouray, Colorado nestled below the tall mountains from above, along the Million Dollar Highway',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Ouray_CO.jpg&action=history',
			...
			carousel_3: [
...

				{
					attraction: 'Million Dollar Highway (HWY 550)',
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-San-Juan-National-Forest-Million-Dollar-Highway-Sunset.jpg',
					image_alt:
						"Sunset view along the valley road of Highway 550 aka the Million Dollar Highway in Colorado's San Juan National Forest",
			...
			carousel_4: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-San-Juan-National-Forest-Island-Lake.jpg',
					image_alt:
						"Hiker admiring the stunning glacial blue waters of Island Lake high in the mountains of Colorado's San Juan National Forest",
					cc_image_url:
						'https://www.flickr.com/photos/oakleyoriginals/20755080341/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-San-Juan-National-Forest-Million-Dollar-Highway-Pinkerton-Hot-Springs.jpg',
					image_alt:
						"Strange geothermal structure of Pinkerton Hot Springs seen along Colorado's Million Dollar Highway 550",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Durango-Durango-Silverton-Narrow-Gauge-Railroad.jpg',
					image_alt:
						'Looking along the river beside the train along the Durango and Silverton Narrow Gauge Rail through San Juan National Forest',
					cc_image_url:
						'https://www.flickr.com/photos/bluecorvette/9302844960/',
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Garden-of-the-Gods-and-Brush-150x150.jpg',
			meta_description:
				'Discover top attractions in Colorado National Monument + McInnis Canyons Arches and plan the perfect trip with our savable Attraction Lists for Google Maps',
			meta_keywords:
				'colorado national monument attractions guide, colorado national monument top attractions, colorado national monument destination guide, colorado national monument google maps list, colorado national monument colorado attractions',
			social_media_title: 'Colorado National Monument, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Garden-of-the-Gods-and-Brush.jpg'
		},
		attractionMapLinks: {
			...
			carousel_1: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Balanced-Rock-View.jpg',
					image_alt:
						'View of the barely standing Balanced Rock along Rimrock Drive through Colorado National Monument',
					cc_image_url:
						'https://www.flickr.com/photos/56181704@N00/10568900505',
					cc_author_url: 'https://www.flickr.com/photos/dph1110/',
					cc_author: 'David Herrera',
					cc_license_url: null,
					cc_license_url:
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Window-Rock.jpg',
					image_alt:
						"Zoomed in view od the natural Window Rock formation amongst the cliffs below Colorado National Monument's Book Cliffs View",
					cc_image_url:
						'https://www.needpix.com/photo/763747/window-rock-scenic-colorado-national-monument-usa-landscape-geology-sandstone-formation-natural',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Rimrock-Drive-Road-Tunnel.jpg',
					image_alt:
						'Looking down the road as it enters a dark tunnel through the cliffs of Colorado National Monument along Rimrock Drive',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Colorado_National_Monument_(8a342dee-adc1-484f-8dc6-a14ad6327f25).jpg&action=history',
			...
			carousel_2: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Independence-Monument-View.jpg',
					image_alt:
						'Stunning view overlooking Independence Monument and surrounding mesas in Colorado National Monument',
...

				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/58869428@N05/34667838504/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Grand-View-East.jpg',
					image_alt:
						"Overlooking complex rock pillars and cliffs of Monument Canyon from Colorado National Monument's Grand View",
...

				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/72213316@N00/4475645162/',
			...
			carousel_3: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Upper-Ute-Canyon-View.jpg',
					image_alt:
						'Overlooking a natural alcove carved out of the long canyon walls of Upper Ute Canyon at Colorado National Monument',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Colorado_National_Monument_(2e0539e4-0d83-4984-ab3a-c59787a830a3).jpg&action=history',
					cc_author_url: 'https://npgallery.nps.gov/',
					cc_author: 'National Park Service',
					cc_license_url: null,
					cc_license_url:
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Ute-Canyon-View.jpg',
					image_alt:
						"Stunning viewpoint overlooking Colorado National Monument's Ute Canyon at a bend in the canyon",
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Scenery_at_Colorado_National_Monument,_a_preserve_of_vast_plateaus,_canyons,_and_towering_monoliths_in_Mesa_County,_Colorado,_near_Grand_Junction_LCCN2015633000.tif&action=history',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Red-Canyon-Overlook.jpg',
					image_alt:
						'Looking down the center of the long Red Canyon from above at Colorado National Monument',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Colorado_National_Monument_(9392909d-3471-4b1a-85e1-eb41b20f81b9).jpg&action=history',
					cc_author_url: 'https://npgallery.nps.gov/',
					cc_author: 'National Park Service',
					cc_license_url: null,
					cc_license_url:
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-National-Monument-Cold-Shivers-Point-Overlook.jpg',
					image_alt:
						'Small rock platform at the Cold Shivers Point Overlook along the cliffs at Colorado National Monument',
			...
			carousel_4: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-McInnis-Canyons-Black-Ridge-Canyons-Wilderness-Rattlesnake-Arches-Trail-Black-Ridge-Canyon.jpg',
					image_alt:
						"Golden hour view overlooking small natural arches of Black Ridge Canyon Wilderness at Colorado's McInnis Canyons",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-McInnis-Canyons-Black-Ridge-Canyons-Wilderness-Rattlesnake-Arches-Trail-East-Rim-Arch.jpg',
					image_alt:
						"Looking up at the large East Rim Arch along the Rattlesnake Arches Trail of Black Ridge Canyons at Colorado's McInnis Canyons",
					cc_image_url:
						'https://www.flickr.com/photos/iagoarchangel/14703677325/',
...

				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/blmcolorado/49758424847/',
					cc_author_url: 'https://www.flickr.com/photos/blmcolorado/',
					cc_author: 'BLM-Colorado',
					cc_license_url: null,
					cc_license: null
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-McInnis-Canyons-Black-Ridge-Canyons-Wilderness-Rattlesnake-Arches-Trail-Cedar-Tree-Arch-Behind.jpg',
					image_alt:
						"Overlooking the Cedar Tree Atch from behind along the Rattlesnake Arches Trail of Colorado's McInnis Canyons",
					cc_image_url: 'https://flickr.com/photos/50212228@N08/49758424847',
					cc_author_url: 'https://www.flickr.com/photos/blmcolorado/',
					cc_author: 'BLM-Colorado',
					cc_license_url: null,
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-McInnis-Canyons-Black-Ridge-Canyons-Wilderness-Rattlesnake-Arches-Trail-Bridge-Arch.jpg',
					image_alt:
						"Looking up at the Bridge Arch with a small hole in it along the Rattlesnake Arches Trail of Colorado's Black Ridge Canyon",
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Bridge_arch.jpg&action=history',
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Elk-Herd-on-Sand-Dunes-150x150.jpg',
			meta_description:
				'Discover top attractions in Colorado Springs, Colorado + Pikes Peak, and plan the perfect trip with our savable Attraction Lists for Google Maps',
			meta_keywords:
				'colorado springs attractions guide, colorado springs top attractions, colorado springs destination guide, colorado springs google maps list, colorado springs colorado attractions',
			social_media_title: 'Colorado Springs, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Elk-Herd-on-Sand-Dunes.jpg'
		},
		attractionMapLinks: {
		...
		attractions: {
			carousel_1: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Pioneers-Museum.jpg',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Balanced-Rock.jpg',
					image_alt:
						'Close-up view of the giant seeminly gravity-defying Balanced Rock of Colorado Springs, Colorado',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Balanced_Rock.jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Balanced_Rock.jpg&action=history',
					cc_author: 'EvanS',
					cc_license_url: null,
			...
			carousel_2: [
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Will-Rogers-Shrine-of-the-Sun-View.jpg',
					image_alt:
						'View overlooking the forests and suburbs of Colorado Springs from the Will Rogers Shrine of the Sun',
					cc_image_url:
						'https://www.flickr.com/photos/just1page/36445509420/in/photostream/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Seven-Bridges-Trail.jpg',
					image_alt:
						'Close-up view of small waterfall along the Seven Bridges Trail in Colorado Springs',
					cc_image_url:
						'https://www.flickr.com/photos/markbyzewski/15795526578/',
					cc_author_url: 'https://www.flickr.com/photos/markbyzewski/',
					cc_author: 'mark byzewski',
					cc_license_url: null,
					cc_license_url:
			...
			carousel_3: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Pikes-Peak-Cog-Railway.jpg',
					image_alt:
						'Red train cars of the Pikes Peak Cog Railway at the station atop Pikes Peak above Colorado Springs',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Manitou-Cliff-Dwellings.jpg',
					image_alt:
						'Replicas of 800 year old Native American structures at the Manitou Cliff Dwellings at Manitou Springs, Colorado',
					cc_image_url:
						'https://www.flickr.com/photos/inthe-arena/39339804752/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Colorado-Springs-Miramont-Castle.jpg',
					image_alt:
						'Facade of the lovely Miramont Castle of Manitou Springs near Colorado Springs',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Miramont_(Manitou_Springs,_Colorado).JPG&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/wiki/User:Denverjeffrey',
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Denver-Downtown-Denver-and-Mountains-Aerial-View-150x150.jpg',
			meta_description:
				'Discover top attractions & hiking trails in Denver & Boulder, Colorado, and plan the perfect trip with our savable Denver Attraction Lists for Google Maps',
			meta_keywords:
				'denver attractions guide, denver top attractions, denver destination guide, denver google maps list, denver colorado attractions',
			social_media_title: 'Denver & Boulder, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Denver-Downtown-Denver-and-Mountains-Aerial-View.jpg'
		},
		attractionMapLinks: {
		...
		attractions: {
			carousel_1: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Denver-Art-Museum.jpg',
					image_alt:
						'Stunning ultramodern architecture of the Denver Art Museum in Downtown Denver, Colorado',
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Denver-Botanic-Gardens.jpg',
					image_alt:
						'Pond surrounded by beautiful trees at the Denver Botanic Gardens in Downtown Denver, Colorado',
					cc_image_url:
						'https://www.flickr.com/photos/markbyzewski/34836571376/',
					cc_author_url: 'https://www.flickr.com/photos/markbyzewski/',
					cc_author: 'mark byzewski',
					cc_license_url: null,
					cc_license_url:
			...
			carousel_2: [
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Roxborough-State-Park-South-Rim-Trail.jpg',
					image_alt:
						"Many large sloped rocks emerging from the green landscape seen along Roxborough State Park's South Rim Loop Trail in Colorado",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Pearl-Street-Mall.jpg',
					image_alt:
						"Pedestrian walkways surrounded by shops along Boulder, Colorado's Pearl Street Mall",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Sunrise-Amphitheater.jpg',
					image_alt:
						"Circular stone seating of Boulder, Colorado's Sunrise Amphitheater offering views overlooking Boulder from high above",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Lost-Gulch-Overlook.jpg',
					image_alt:
						'Expansive forests covering the rolling hills and mountains of Colorado seen from the Lost Gulch Overlook above Boulder, CO',
					cc_image_url:
						'https://www.flickr.com/photos/brady_wieland/36859907692',
			...
			carousel_3: [
				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/collins_family/37417921536/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Denver-Boulder-Eldorado-Canyon-Rattlesnake-Gulch-Trail.jpg',
					image_alt:
						'Rugged rocky mountains and forests seen along the Rattlesnake Gulch Trail of Eldorado Canyon State Park, Colorado',
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Cliff-Palace-Cliff-Dwellings-View-150x150.jpg',
			meta_description:
				'Discover top attractions in Mesa Verde National Park, Colorado, and plan the perfect trip with our savable Mesa Verde Attraction Lists for Google Maps',
			meta_keywords:
				'mesa verde attractions guide, mesa verde top attractions, mesa verde destination guide, mesa verde google maps list, mesa verde colorado attractions',
			social_media_title: 'Mesa Verde National Park, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Cliff-Palace-Cliff-Dwellings-View.jpg'
		},
		attractionMapLinks: {
		...
		attractions: {
			carousel_1: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Montezuma-Valley-Overlook.jpg',
					image_alt:
						'Vast forests of Southwestern Colorado seen from above the Montezuma Valley Overlook at Mesa Verde National Park',
					cc_image_url:
						'https://www.flickr.com/photos/24707395@N02/2576613848/',
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Coyote-Village.jpg',
					image_alt:
						"Amazing brick ruins of the Coyote Village at Colorado's Mesa Verde National Park",
					cc_image_url:
						'https://www.flickr.com/photos/23155134@N06/5913057362/',
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Far-View-House.jpg',
					image_alt:
						'Stone circles and sturctures of the Far View Ruins at Mesa Verde National Park, Colorado',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Spruce-Tree-House.jpg',
					image_alt:
						'Overlooking the many structures of the Spruce Tree House cliff dwellings within an alcove at Mesa Verde National Park',
					cc_image_url:
						'https://www.flickr.com/photos/twiga_swala/24278381577/',
			...
			carousel_2: [
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Sun-Point-View.jpg',
					image_alt:
						"Overlooking a forest canyon filled with Native American cliff dwellings from Mesa Verde National Park's Sun Point View",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Oak-Tree-House.jpg',
					image_alt:
						"View from Mesa Top Loop Road overlooking the Oak Tree House cliff dwellings at Colorado's Mesa Verde National Park",
					cc_image_url:
						'https://www.flickr.com/photos/kenlund/4848649246/in/photostream/',
					cc_author_url: 'https://www.flickr.com/photos/kenlund/',
					cc_author: 'Ken Lund',
					cc_license_url: null,
					cc_license_url:
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Sun-Temple.jpg',
					image_alt:
						"Looking down the walkway between the walls of the Sun Temple at Colorado's Mesa Verde National Park",
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Cliff-Palace-Cliff-Dwellings-View.jpg',
					image_alt:
						'Overlooking the Cliff Palace cliff dwelling mini city below the canyon in Mesa Verde National Park, Colorado',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Balcony-House.jpg',
					image_alt:
						'Close-up view looking along the cliff dwelling ruins of the Balcony House at Mesa Verde National Park, Colorado',
			...
			carousel_3: [
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Mesa-Verde-National-Park-Step-House.jpg',
					image_alt:
						"Alcove cliff swelling ruins of the Step House at Wetherill Mesa, at Colorado's Mesa Verde National Park",
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Bear-Lake-Area-Emerald-Lake-150x150.jpg',
			meta_description:
				'Discover top attractions & hiking trails in Rocky Mountain National Park, Colorado, and plan the perfect trip with savable Attraction Lists for Google Maps',
			meta_keywords:
				'rocky mountain attractions guide, rocky mountain top attractions, rocky mountain destination guide, rocky mountain google maps list, rocky mountain colorado attractions',
			social_media_title:
				'Rocky Mountain National Park, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Bear-Lake-Area-Emerald-Lake.jpg'
		},
		attractionMapLinks: {
			...
			carousel_1: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Many-Parks-Curve-Overlook.jpg',
					image_alt:
						'Mountain view from behind trees sen from the Many Parks Curve Overlook along Highway 34 at Rocky Mountain National Park',
					cc_image_url:
						'https://www.flickr.com/photos/adifferentbrian/36503570855/',
					cc_author_url: 'https://www.flickr.com/photos/adifferentbrian/',
					cc_author: 'adifferentbrian',
					cc_license_url: null,
					cc_license_url:
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Rainbow-Curve-Overlook.jpg',
					image_alt:
						"Beautiful mountains and forests admired from Highway 34's Rainbow Curve Overlook in Rocky Mountain National Park",
					cc_image_url:
						'https://www.flickr.com/photos/adifferentbrian/35668622534/',
					cc_author_url: 'https://www.flickr.com/photos/adifferentbrian/',
					cc_author: 'adifferentbrian',
					cc_license_url: null,
					cc_license_url:
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Forest-Canyon-Overlook.jpg',
					image_alt:
						'Walkway leading to the stunning Forest Canyon Overlook oferring views over the snow-capped Rocky Mountains',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Rocky_Mountain_National_Park_Colorado-Forest_Canyon_Overlook_on_Trail_Ridge_Road-20060608133107.jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Rocky_Mountain_National_Park_Colorado-Forest_Canyon_Overlook_on_Trail_Ridge_Road-20060608133107.jpg&action=history',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Gore-Range-Overlook.jpg',
					image_alt:
						'View of the snow-topped Rock Mountains behind grassy rolling hills seen from the Gore Range Overlook',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Gore_Range_Overlook,_RMNP,_July_2016.jpg&action=history',
			...
			carousel_2: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Prospect-Mountain.jpg',
					image_alt:
						'View overlooking Estes Park from atop Prospect Mountain in Rocky Mountains National Park',
...

				{
					attraction: 'Gem Lake',
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Gem-Lake.jpg',
					image_alt:
						'View looking along Gem Lake, a popular hike in Rocky Mountains National Park, Colorado',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Sprague-Lake.jpg',
					image_alt:
						'Stunning view of the snow-capped Rocky Mountains and their reflection in the waters os Sprague Lake',
					cc_image_url:
						'https://www.flickr.com/photos/58869428@N05/34749488163/',
					cc_author_url: 'https://www.flickr.com/photos/58869428@N05/',
					cc_author: 'Todd Petrie',
					cc_license_url: null,
					cc_license_url:
			...
			carousel_3: [
				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/bsc_photgraphy/7243762556/',
...

				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/collins_family/36524220733/',
					cc_author_url: 'https://www.flickr.com/photos/collins_family/',
					cc_author: 'Chris Collins',
					cc_license_url: null,
					cc_license_url:
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Dream-Lake.jpg',
					image_alt:
						'Deep blue waters of Dream Lake below tall mountains seen along a hiking trail at Rocky Mountain National Park',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Emerald-Lake.jpg',
					image_alt:
						'Bowl-like Emerald Lake surrounded by tall mountain peaks of Rocky Mountain National Park in Colorado',
			...
			carousel_4: [
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Lily-Lake.jpg',
					image_alt:
						'Overlooking the blue waters of Lily Lake in Rocky Mountain National Park',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Ouzel-Falls.jpg',
					image_alt:
						'Close-up view of the waters of Ouzel Falls at Rocky Mountain National Park',
					cc_image_url:
						'https://www.flickr.com/photos/darkdenver/7273959164/in/photostream/',
					cc_author_url: 'https://www.flickr.com/photos/darkdenver/',
					cc_author: 'Steven Bratman',
					cc_license_url: null,
					cc_license_url:
			...
			carousel_5: [
				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/14480409@N04/15287851668/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Lake-Isabelle.jpg',
					image_alt:
						"Idyllic view overlooking Rocky Mountain National Park's Lake Isabelle below tall mountain peaks",
					cc_image_url:
						'https://www.flickr.com/photos/freeflight046/2859014642/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rocky-Mountain-National-Park-Diamond-Lake.jpg',
					image_alt:
						'View along the surface of Diamond Lake with a beautiful refelction, at Rocky Mountain National Park',
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Elk-Herd-on-Sand-Dunes-150x150.jpg',
			meta_description:
				'Discover top attractions along the route from Colorado to New Mexico, and plan the perfect trip with our savable Attraction Lists for Google Maps',
			meta_keywords:
				'san luis valley attractions guide, san luis valley top attractions, san luis valley destination guide, san luis valley google maps list, san luis valley colorado attractions',
			social_media_title:
				'San Luis Valley & Canon City, Colorado Attractions Guide',
			social_media_thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Elk-Herd-on-Sand-Dunes.jpg'
		},
		attractionMapLinks: {
		...
		attractions: {
			carousel_1: [
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-San-Luis-Valley-Mosca-Colorado-Gators-Reptile-Park.jpg',
					image_alt:
						"Lots of alligators swimming in close proximity seen at Mosca's Colorado Gators Reptile Park in the San Luis Valley",
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Co_mosca_gator_farm1.jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/wiki/User:Dk4hb~commonswiki',
					cc_author: 'Dk4hb',
					cc_license_url: null,
					cc_license: null
				}
			...
			carousel_2: [
				{
					...
					image_alt:
						"Picturesque view of giant sand dunes set amongst the blue sky at Great Sand Dunes National Park in Colorado's San Luis Valley",
					cc_image_url:
						'https://www.flickr.com/photos/watsonsinelgin/28244777805/',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Elk-Herd-on-Sand-Dunes.jpg',
					image_alt:
						"Herd of elk seen amongst the wildlife living in Colorado's Great Sand Dunes National Park in the San Luis Valley",
					cc_image_url:
						'https://www.flickr.com/photos/greatsanddunesnpp/16519301272/',
...

				{
					attraction: 'Great Sand Dunes National Park',
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Sand-Dunes-and-People.jpg',
					image_alt:
						'People provide a reference size for the massive scale of the dunes at Great Sand Dunes National Park, Colorado',
					cc_image_url:
						'https://www.flickr.com/photos/greatsanddunesnpp/23088833242/',
					cc_author_url: 'https://www.flickr.com/photos/greatsanddunesnpp/',
					cc_author: 'Great Sand Dunes N.P.',
					cc_license_url: null,
					cc_license: null
...

				{
					...
					image_alt:
						"Visitors enjoying the waters of Medano Creek beside the dunes of Colorado's Great Sand Dunes National Park and Mt. Herard in background",
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Great_Sand_Dunes_National_Park_-_Medano_Creek,_dunes_and_Sangre_de_Cristo_Mountains.jpg&action=history',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rio-Grande-National-Forest-Zapata-Falls.jpg',
					image_alt:
						"Close-up view of the beautiful rocky waters of Zapata Falls near Great Sand Dunes in Colorado's Rio Grande National Forest",
			...
			carousel_3: [
				{
					...
					cc_image_url:
						'https://www.flickr.com/photos/22711505@N05/9583764825/',
...

				{
					...
					image_alt:
						'Hlauuma North House anicent adobe structure of Taos Pueblo seen behind the river at Taos, New Mexico',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Taos_north_pueblo.jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Taos_north_pueblo.jpg&action=history',
					cc_author: 'Obiwannm',
					cc_license_url: null,
...

				{
					...
					image_alt:
						'Ruins of the colonial Spanish mission church of San Geronimo and cemetery at Taos Pueblo, New Mexico',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:DSC_1708_Taos_Pueblo,_New_Mexico.jpg&action=history',
					cc_author_url:
						'https://commons.wikimedia.org/w/index.php?title=File:DSC_1708_Taos_Pueblo,_New_Mexico.jpg&action=history',
...

				{
					...
					image_alt:
						'Beautiful adobe structures line the walkways near Taos Plaza at the Downtown Taos Historic District in Taos, New Mexico',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Taos_Plaza_13.JPG&action=history',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/new-mexico/New-Mexico-Carson-National-Forest-Taos-El-Prado-Rio-Grande-Gorge-Bridge.jpg',
					image_alt:
						'Overlooking one of the highest bridges in the USA, the Rio Grande Gorge Bridge, located near Taos, New Mexico',
	...
	},
	{
		...
		meta: {
			...
			thumbnail:
				'https://www.travelimager.com/images/colorado/Colorado-Great-Sand-Dunes-National-Park-Wetlands-Cranes-Sand-Dunes-and-Mount-Herard-Sunset-Golden-Hour-150x150.jpg',
			meta_description:
				'Discover top attractions in Southern Colorado + Great Sand Dunes National Park, and plan the perfect trip with savable Google Maps Attraction Lists',
			meta_keywords:
				'southern colorado attractions guide, southern colorado top attractions, southern colorado destination guide, southern colorado google maps list, southern colorado attractions',
		...
		attractions: {
			carousel_1: [
				...
				},
				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-San-Juan-National-Forest-Pagosa-Springs-Wolf-Creek-Pass-Overlook.jpg',
					image_alt:
						'Overlooking a lush green valley surrounded by the San Juan National Forest from Wolf Creek Pass Overlook in Southern Colorado',
					cc_image_url:
						'https://commons.wikimedia.org/w/index.php?title=File:Wolf_Creek_Pass_View_on_West_towards_West_by_Erik_Voss_IMG_4012.JPG&action=history',
...

				{
					...
					image_url:
						'https://www.travelimager.com/images/colorado/Colorado-Rio-Grande-National-Forest-Zapata-Falls.jpg',
					image_alt:
						'Rocky stream of below the waters of Zapata Falls close-by Great Sand Dunes National Park in Southern Colorado',
					cc_image_url: 'https://www.flickr.com/photos/brokentaco/2605177741/',
					cc_author_url: 'https://www.flickr.com/photos/brokentaco/',
					cc_author: 'David',
					cc_license_url: null,
