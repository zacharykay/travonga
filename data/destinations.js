export const destinations = [
	{
		...
		destinations: [
			...
			},
			{
				...
				image_alt:
					'View overlooking the Burgruine Aggstein Castle ruins and the Danube River valley below in the Wachau Valley town of Aggstein in Austria',
				cc_image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Austria's top destinations: Vienna, Salzburg, Hallstatt, Salzkammergut Region, Wachau Valley, Werfen, & Greater Vienna Castles",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				stateName: 'Belgium',
				page_url:
					'/destinations/belgium/dinant-namur-and-waterloo-attractions-guide',
				image_url:
					'https://www.travelimager.com/images/belgium/Belgium-Southeastern-Belgium-Dinant-Meuse-River-Southwest-Citadel-Notre-Dame-Viewpoint.jpg',
				image_alt:
					'Colorful buildings, the Dinant Citadel, and Notre Dame Cathedral, all seen in one frame from a viewpoint along the Meuse River, southwest of the Charles de Gaulle Bridge in Dinant, Belgium',
				cc_image_url:
					'https://commons.wikimedia.org/w/index.php?title=File:Notre_Dame_de_Dinant_and_Citadel.jpg&action=history',
				cc_author_url:
					'https://commons.wikimedia.org/w/index.php?title=File:Notre_Dame_de_Dinant_and_Citadel.jpg&action=history',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Belgium's top destinations: Brussels, Bruges, Dinant, Namur, and Waterloo",
	...
	},
	{
		...
		destinations: [
			{
				...
				stateName: 'Czech Republic',
				page_url:
					'/destinations/czech-republic-czechia/greater-prague-attractions-guide',
				image_url:
					'https://www.travelimager.com/images/czech-republic/Czechia-Czech-Republic-Greater-Prague-Kutna-Hora-Sedlec-Ossuary-Bone-Church.jpg',
				image_alt:
					'Thousands of century-old human bones and skulls arranged into ornate designs within the famous Sedlec Ossuary of Kutna Hora near Prague, Czech Republic',
				cc_image_url:
					'https://www.flickr.com/photos/voxaeterno/15030155346/in/photostream/',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for the Czech Republic / Czechia's top destination, Prague, and castles and other attraction in the Greater Prague area",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				stateName: 'England',
				page_url:
					'/destinations/england/stratford-upon-avon-and-warwick-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for England's top destinations: London, Stonehenge, Bath, Oxford, Cambridge, Costwolds, Dover, Stratford-upon-Avon, Kent, & more",
	...
	},
	{
		...
		destinations: [
			{
				...
				stateName: 'France',
				page_url:
					'/destinations/france/alpilles-and-luberon-natural-parks-attractions-guide',
				image_url:
					'https://www.travelimager.com/images/france/France-Alpilles-Luberon-Gordes-Town-Viewpoint.jpg',
				image_alt:
					'Rustic hillside village of Gordes viewed from afar in Provence, France',
			...
			},
			{
				...
				stateName: 'France',
				page_url:
					'/destinations/france/alsace-towns-and-greater-colmar-attractions-guide',
				image_url:
					'https://www.travelimager.com/images/france/France-Alsace-Region-Eguisheim-Village.jpg',
				image_alt:
					'Iconic coloful half-timbered houses in the village of Eguisheim, Alsace region of France near Colmar',
			...
			},
			{
				...
				image_alt:
					'Grand Medieval Papal Palace viewed from afar in Avignon, France',
				cc_image_url:
			...
			},
			{
				...
				image_alt:
					'Porte Cailhau intricate medieval gate to the city of Bordeaux, France',
				cc_image_url:
			...
			},
			{
				...
				image_alt:
					'Beautiful multi-colored half-timbered houses along a canal in La Petite Venise Fishmonger District of Colmar, France',
				cc_image_url:
			...
			},
			{
				...
				image_alt:
					'Chateau de Chenonceau Castle, Chenonceau, Loire Valley, France',
				cc_image_url:
			...
			},
			{
				...
				image_alt:
					'Vibrant blue waters and beach of Villefranche-sur-Mer near Nice, France',
				cc_image_url:
			...
			},
			{
				...
				stateName: 'France',
				page_url:
					'/destinations/france/st-malo-and-mont-saint-michel-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for France's top destinations: Paris, Loire Valley, Strasbourg, Colmar, Nice, Carcassonne, Marseille, Lyon, Avignon, St. Malo, & more",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				stateName: 'Germany',
				page_url:
					'/destinations/germany/fussen-and-neuschwanstein-castle-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Germany's top destinations: Berlin, Munich, Neuschwanstein Castle, Rhine River Valley, Cologne, Heidelberg, Koblenz, Fussen, & more",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				stateName: 'Greece',
				page_url:
					'/destinations/greece/western-crete-and-chania-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Greece's top destinations: Athens, Santorini, Zakynthos, Kefalonia, Mykonos, Rhodes, Delphi, Meteora, Paros, Naxos, Crete, & more",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				image_url:
					'https://www.travelimager.com/images/ireland/Ireland-Dublin-St-Michaels-Church-Dublinia.jpg',
				image_alt:
					"Covered stone bridge connecting the Christ Church Cathedral and Dublinia Museum of St. Michael's Church in Dublin, Ireland",
				cc_image_url:
					'https://commons.wikimedia.org/w/index.php?title=File:Dublin_-_Christ_Church_Cathedral_-_110508_143136.jpg&action=history',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Ireland's top destinations: Dublin, Galway, Cliffs of Moher, Ring of Kerry, Cork, Belfast, Causeway Coast, Northern Ireland, & more",
...

	{
		...
		destinations: [
			...
			},
			{
				...
				image_alt:
					"Picturesque view over Capri stretching to the Sorrentine Peninsula and Italian Mainland from Capri Island's Monte Solaro",
				cc_image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Italy's top destinations: Rome, Venice, Florence, Amalfi Coast, Lake Como, Pompeii, Naples, Capri, Cinque Terre, Milan, Pisa, & more",
...

	{
		...
		destinations: [
			...
			},
			{
				...
				image_alt:
					'Markthal marketplace exterior during the day in Rotterdam, Netherlands',
				cc_image_url:
					'https://commons.wikimedia.org/w/index.php?title=File:Markthal_-_Rotterdam.jpg&action=history',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for the Netherlands's top destinations: Amsterdam, Rotterdam and Gouda, and Zaanse Schans, Keukenhof, & Haarlem around Greater Amsterdam",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				stateName: 'Northern Ireland',
				page_url:
					'/destinations/northern-ireland/causeway-coast-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Northern Ireland's top destinations: Galway and the Causeway Coast, including Giant's Causeway, Carrick-a-Rede, & Ballintoy",
		...
		destinations: [
			{
				...
				image_alt:
					"Stunningly beautiful and iconic natural arch formations along the coastal cliffs of Lagoa at the famous Praia da Marniha Beach, along Portugal's Algarve Coast",
...

	{
		...
		destinations: [
			...
			},
			{
				...
				image_alt:
					'Stunning craggy rocks of Old Man of Storr sticking out of the vibrant green hilly landscape above the Isle of Skye coastline',
			...
			},
			{
				...
				stateName: 'Scotland',
				page_url:
					'/destinations/scotland/loch-lomond-and-the-trossachs-attractions-guide',
				image_url:
			...
			},
			{
				...
				stateName: 'Scotland',
				page_url:
					'/destinations/scotland/northwestern-highlands-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Scotland's top destinations: Edinburgh, Isle of Skye, Loch Ness, Scottish Highlands, Inverness, Loch Lomond, Glasgow, Argyll & Bute",
	...
	},
	{
		...
		destinations: [
			{
				...
				image_url:
					'https://www.travelimager.com/images/slovenia/Slovenia-Bled-Bled-Island.jpg',
				image_alt:
					'Tiny island in the middle of Lake Bled hosting a beautiful church, in Bled, Slovenia',
			...
			},
			{
				...
				image_url:
					'https://www.travelimager.com/images/slovenia/Slovenia-Ljubljana-Congress-Square.jpg',
				image_alt:
					'Beautiful Congress Square with hilltop Ljubljana rising high above the other end of the square in the background in Slovenia',
			...
			},
			{
				...
				hideStateName: true,
				page_url:
					'/destinations/slovenia/southwestern-slovenia-attractions-guide',
				image_url:
					'https://www.travelimager.com/images/slovenia/Slovenia-Southwestern-Slovenia-Predjama-Castle.jpg',
				image_alt:
					'Stunning medieval Predjama Castle built into the cliffside in Southwestern Slovenia',
				cc_image_url:
					'https://commons.wikimedia.org/w/index.php?title=File:Predjama_castle,_Slovenia.jpg&action=history',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Slovenia's top destinations: Ljubljana, Bled, and Southwestern Slovenia's Postojna Cave, Skocjan Cave, & Predjama Castle",
	...
	},
	{
		...
		destinations: [
			{
				...
				image_alt:
					'View of the imposing medieval alls of Avila stretching for kilometers',
			...
			},
			{
				...
				image_alt:
					'Beautiful lavish gardens of the Alcazar of the Christian Monarchs castle in Cordoba',
				cc_image_url:
			...
			},
			{
				...
				image_alt:
					"Idyllic sandy beach with beautiful blue waters and the massive Penyal d'Ifac Rock in the background in the city of Calpe",
				cc_image_url:
			...
			},
			{
				...
				image_alt:
					"Iconic view of the Generalife Gardens' Patio de la Acequia in Granada",
			...
			},
			{
				...
				image_alt:
					'View from below from the grassy field viewpoint known as the Mirador de la Pradera de San Marcos of the Alcazar de Segovia Castle',
			...
			},
			{
				...
				image_alt:
					'Stunningly beautiful sunset view of the massive Plaza de Espana in Seville',
			...
			},
			{
				...
				image_alt:
					'Stunning ultra-contemporary archtectural masterpiece of the City of Arts and Sciences in Valencia, which somewhat resembles a whale skeleton',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Spain's top destinations: Barcelona, Ibiza, Costa Blanca, Valencia, Granada, Madrid, Segovia, Toledo, Seville, Cordoba, Bilbao & more",
	...
	},
	{
		...
		destinations: [
			...
			},
			{
				...
				stateName: 'Switzerland',
				page_url:
					'/destinations/switzerland/bernese-oberland-and-interlaken-attractions-guide',
				image_url:
			...
			},
			{
				...
				stateName: 'Switzerland',
				page_url:
					'/destinations/switzerland/zermatt-and-matterhorn-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Switzerland's top destinations: Lucerne, Bern, Zermatt, Matterhorn, and Bernese Oberland towns of Interlaken, Meiringen, & Brienz",
	...
	},
	{
		...
		destinations: [
			{
				...
				image_url:
					'https://www.travelimager.com/images/british-columbia/British-Columbia-Greater-Vancouver-Whistler-Mountain-High-Note-Trail-Cheakamus-Lake-Southeast-View.jpg',
				image_alt:
			...
			},
			{
				...
				stateName: 'British Columbia',
				page_url:
					'/destinations/british-columbia/victoria-and-vancouver-island-attractions-guide',
				image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for British Columbia, Canada's top destinations: Victoria, Vancouver, Greater Vancouver Hiking, Whistler, and Vancouver Island",
...

	{
		...
		destinations: [
			...
			},
			{
				...
				image_url:
					'https://www.travelimager.com/images/arizona/Arizona-Northeastern-Arizona-Jasper-Forest.jpg',
				image_alt:
					"Ancient petrified wood logs along the purple landscape of Petrified Forest National Park's Jasper Forest in Northern Arizona",
				cc_image_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Arizona's top destinations: Sedona, Grand Canyon, Page, Horseshoe Bend, Petrified Forest, Phoenix, Flagstaff, Canyon de Chelly & more",
...

	{
		...
		destinations: [
			...
			},
			{
				...
				image_url:
					'https://www.travelimager.com/images/california/California-Los-Angeles-Griffith-Observatory-Sunset.jpg',
				image_alt:
					'Sunset over the famous Griffith Observatory with the skyscrapers of Downtown Los Angeles in the background',
				cc_image_url:
					'https://pixabay.com/photos/griffith-observatory-los-angeles-3897616/',
			...
			},
			{
				...
				stateName: 'California',
				page_url:
					'/destinations/california/orange-county-attractions-guide-by-car',
				image_url:
			...
			},
			{
				...
				stateName: 'California',
				page_url:
					'/destinations/california/point-reyes-and-mt-tamalpais-attractions-guide-by-train',
				image_url:
			...
			},
			{
				...
				image_alt:
					"Overlooking the beautiful Golden Gate Bridge near San Francisco's Fort Point spanning the entrance to the San Francisco Bay",
				cc_image_url:
					'https://pixabay.com/photos/the-golden-gate-bridge-bridge-1956459/',
			...
			},
			{
				...
				image_url:
					'https://www.travelimager.com/images/california/California-Yosemite-National-Park-Nevada-Falls-2.jpg',
				image_alt:
					'John Muir Trail view of Nevada Falls flowing over the cliffs beside the Liberty Cap and dense forests in Yosemite Valley',
				cc_image_url:
					'https://www.flickr.com/photos/146738176@N02/32050699197/in/photostream/',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for California's top destinations: San Diego, Los Angeles, San Francisco, Yosemite, Joshua Tree, Central Coast, Redwoods, Lassen, & more",
	...
	},
	{
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Colorado's top destinations: Rocky Mountains, Aspen, Mesa Verde, Denver, Boulder, Colorado Springs, Gunnison, Great Sand Dunes & more",
	...
	},
	{
		...
		destinations: [
			{
				...
				stateName: 'Nevada',
				page_url:
					'/destinations/nevada/great-basin-national-park-and-cathedral-gorge-attractions-guide',
				image_url:
					'https://www.travelimager.com/images/nevada/Nevada-Cathedral-Gorge-State-Park-Cliffs-Golden-Hour.jpg',
				image_alt:
					'Golden hour over the striking golden cliffs of Cathedral Gorge State Park in rural Nevada',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Nevada's top destinations: Las Vegas, Red Rock Canyon, Valley of Fire, Lake Tahoe, Cathedral Gorge, & Great Basin National Park",
	...
	},
	{
		...
		destinations: [
			{
				...
				image_url:
					'https://www.travelimager.com/images/new-mexico/New-Mexico-Albuquerque-Hot-Air-Balloon-Festival-Aerial-View-of-Balloons-over-River.jpg',
				image_alt:
					'Colorful balloons above the Rio Grande River during the Albuquerque International Balloon Fiesta Festival in New Mexico',
				cc_image_url:
					'https://pixabay.com/photos/albuquerque-balloons-ballooning-sky-4643828/',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for New Mexico's top destinations: Santa Fe, Taos, Abiquiu, Carlsbad Caverns, White Sands National Park, and Albuquerque",
	...
	},
	{
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Oregon's top destinations: Crater Lake, Bend, Oregon Coast & Beaches, Columbia River Gorge Waterfalls, Portland, Silver Falls, & more",
...

	{
		...
		destinations: [
			{
				...
				stateName: 'Utah',
				page_url:
					'/destinations/utah/arches-national-park-and-moab-attractions-guide',
				image_url:
			...
			},
			{
				...
				image_alt:
					"Stunning pointed Capital Dome formation seen along the road travelling through Utah's Capitol Reef National Park",
				cc_image_url: 'https://travonga.com/',
				cc_author_url: 'https://travonga.com/',
				cc_author: 'Travonga',
				cc_license_url:
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Utah's top destinations: Zion, Bryce Canyon, Arches National Park, Monument Valley, Canyonlands, Capitol Reef, & more",
...

	{
		...
		destinations: [
			...
			},
			{
				...
				image_url:
					'https://www.travelimager.com/images/washington/Washington-Seattle-Downtown-Space-Needle-and-Mount-Rainier.jpg',
				image_alt:
					'Seattle Space Needle seen among lit up Downtown Seattle with Mount Rainier in the background at sunset',
				cc_image_url:
					'https://pixabay.com/photos/city-skyline-seattle-downtown-693502/',
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Washington's top destinations: Seattle, Olympic National Park, Mt. Rainier, Mt. St. Helens, Mt. Baker, & North Cascades N.P.",
	...
	},
	{
		...
		meta: {
			...
			meta_description:
				"Attraction Guides for Wyoming's top destinations: Yellowstone National Park and Grand Teton National Park",
