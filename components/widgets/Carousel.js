// Carousel Built from Scratch not Currently in Use
        ...
        <div className={styles["carousel-standard"]}>
              ...
              {cloned.map((carouselItem, carouselIndex) => {
                ...
                return (
                  <div
                    ...
                    className={styles[position] + " " + styles["carouselItem"]}
                  >
                    <Image alt={image_alt} src={image_url} width={640} height={480} />
          ...
          {singleCarousel && (
            <div className={singleStyles.singleCarouselItems}>
              {cloned.map((carouselItem, carouselIndex) => {
                const { image_location, image_url, image_alt } = carouselItem;
                ...
                if (
                  carouselIndex === index - 1 ||
                  (index === 0 && carouselIndex === carouselItems.length - 1)
                ) {
                  position = "lastSlide";
                }
                ...
                return (
                  ...
                  >
                    <Image
                      className={singleStyles["single-carousel-image"]}
                      alt={image_alt}
                      src={image_url}
                      width={640}
                      height={480}
                    />
                    <div className={singleStyles["single-carousel-text"]}>
